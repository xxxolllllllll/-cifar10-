...
"""
    加载图片，对图片做数据增强，并对训练集2-8分为80%为训练集和20%为验证集
"""
...
def read_dataset(batch_size=16, valid_size=0.2, num_workers=0, pic_path='../data'):
    """
    ...
    transform_train = transforms.Compose([
        ...
        Cutout(n_holes=1, length=16),   # 在输入的图像上随机“剪切”出一定数量的方形区域，设为黑色
    ])
